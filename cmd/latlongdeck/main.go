...
func readStats(r io.Reader) {
	...
	fmt.Fprintf(os.Stdout, "center=%v,%v -longmin=%v -longmax=%v -latmin=%v -latmax=%v\n", centerLat, centerLong, minxval, maxxval, minyval, maxyval)
}
...
func main() {
	...
	flag.BoolVar(&info, "info", false, "only report bounding box, and center")
	flag.Parse()
